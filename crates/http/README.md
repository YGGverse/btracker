...
βtracker is a social BitTorrent aggregator based on the btracker-fs, btracker-crawler index and [Rocket](https://rocket.rs) web-framework.
...
``` bash
btracker --public=/path/to/btracker-crawler/preload\
         --scrape=udp://127.0.0.1:6969\
         --tracker=udp://[302:68d0:f0d5:b88d::fdb]:6969\
         --tracker=udp://tracker.ygg:6969
```
* The `--public` argument specifies the location of the crawled torrents (see `btracker-crawler`)
